...
export class DrinksComponent implements OnInit {
  ...
  constructor(private storage: AngularFireStorage,
    private drinkService: DrinksService, private toastr: ToastrService) { }
  ...
  addDrink(): void {
    if (this.drinksName && this.drinksUrlName && this.ingredients && this.steps) {
      ...
      this.toastr.success('Drink add', 'Successed');
  ...
  deleteDrink(drink: IDrinks): void {
    ...
    this.drinkService.delete(drink.id.toString())
      .then(() => {
        this.toastr.success('Drink delete', 'Successed');
        this.getDrinks()
      })
      .catch(err => {
        this.toastr.error('Something go wrong', 'Denied');
  ...
  saveDrink(): void {
    ...
    this.drinkService.update(saveD.id.toString(), saveD)
      .then(() => {
        this.toastr.success('Drink update', 'Successed');
        this.getDrinks()
      })
      .catch(err => {
        this.toastr.error('Something go wrong', 'Denied');
